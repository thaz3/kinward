...
| 18 | Shared Management setup | `screens/SCREEN_18_SHARED_MANAGEMENT_SETUP.md` | `03-roles-and-management-modes.md` | UF-06 | AT-007 | D-2, D-3, D-16; owner only | G1 / `draft-group-01-calibrated-200.svg` | Verified production group |
| 19 | Delegated Management setup | `screens/SCREEN_19_DELEGATED_MANAGEMENT_SETUP.md` | `04-delegation-setup.md` | UF-07 | AT-008–AT-013 | D-3–D-5, D-16; owner only | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
| 20 | Delegation scope selection | `screens/SCREEN_20_DELEGATION_SCOPE_SELECTION.md` | `04-delegation-setup.md` | UF-07 | AT-008 | D-3–D-5; owner only | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
| 21 | Delegation expiration selection | `screens/SCREEN_21_DELEGATION_EXPIRATION.md` | `04-delegation-setup.md` | UF-07 | AT-009, AT-010 | D-4, D-5, D-16; owner only | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
| 22 | “Until revoked” selection | `screens/SCREEN_22_UNTIL_REVOKED.md` | `04-delegation-setup.md` | UF-07 | AT-011 | D-4, D-5, D-16; explicit owner consent | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
| 23 | Delegation detail | `screens/SCREEN_23_DELEGATION_DETAIL.md` | `05-delegation-lifecycle.md` | UF-07, UF-08 | AT-008–AT-013 | D-3–D-5, D-16; grant/field scoped | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
...
| 25 | Suspend delegation | `screens/SCREEN_25_SUSPEND_DELEGATION.md` | `05-delegation-lifecycle.md` | UF-08 | AT-012 | D-4, D-5; owner + recent auth | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
| 26 | Revoke delegation | `screens/SCREEN_26_REVOKE_DELEGATION.md` | `05-delegation-lifecycle.md` | UF-08 | AT-013 | D-4, D-5; owner + recent auth | G2 / `draft-group-02-calibrated-200.svg` | Verified production group |
...
| 28 | Backup designation | `screens/SCREEN_28_BACKUP_DESIGNATION.md` | `06-minor-backup-and-continuity.md` | UF-10 | AT-018 | D-6, D-7, D-15; Circle Head only | G3 / `draft-group-03-calibrated-200.svg` | Verified production group |
